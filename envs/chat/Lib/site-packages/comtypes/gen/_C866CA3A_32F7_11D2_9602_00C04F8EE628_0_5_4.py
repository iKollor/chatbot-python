...
__all__ = [
    'SPSHT_Unknown', 'SVSFParseSsml', 'DISPID_SpeechLexiconWords',
    'DISPID_SGRSTsItem', 'DISPID_SLGetPronunciations',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SpeechAudioBufferInfo',
    'SDTRule', 'DISPID_SRRTOffsetFromStart', 'DISPID_SVGetVoices',
    'DISPID_SPPFirstElement', 'SPRECORESULTTIMES',
    'eLEXTYPE_PRIVATE10', 'DISPID_SRIsShared',
    'DISPID_SRGDictationSetState', 'SpUnCompressedLexicon',
    'SPSInterjection', 'DISPID_SVSInputWordLength',
    'DISPID_SRCBookmark', 'DISPID_SRRAudio', 'DISPID_SBSFormat',
    'Speech_Max_Pron_Length', 'DISPID_SpeechPhraseElement',
    'DISPID_SPPChildren', 'DISPID_SRAudioInputStream',
    'DISPID_SPEsItem', 'DISPID_SpeechAudioStatus', 'SGRSTTRule',
    'DISPID_SpeechRecognizerStatus', 'SPRS_ACTIVE',
    'DISPID_SGRsFindRule', 'DISPID_SVSpeak',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SVSFParseSapi',
    'DISPID_SPRulesCount', 'SRARoot', 'SPSEMANTICFORMAT',
    'SAFT16kHz16BitMono', 'ISpProperties', 'DISPID_SPRs_NewEnum',
    'SpeechGrammarState', 'SPPHRASE', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SGRSAddSpecialTransition', 'eLEXTYPE_PRIVATE16',
    'ISpeechAudio', 'SpCompressedLexicon', 'SREInterference',
    'SPEI_SOUND_START', 'SP_VISEME_21', 'SAFT24kHz8BitMono',
    'SpPhoneConverter', 'SGDisplay', 'DISPID_SPERequiredConfidence',
    'SPSNotOverriden', 'SINone', 'SPWF_SRENGINE', 'SPSHT_EMAIL',
    'ISpeechDataKey', 'SECFEmulateResult', 'Speech_Default_Weight',
    'DISPID_SPIProperties', 'SPEI_SR_AUDIO_LEVEL',
    'SAFTADPCM_11kHzMono', 'SPWORDTYPE', 'DISPIDSPTSI',
    'SSTTWildcard', 'SAFT11kHz16BitStereo', 'SVP_2',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SFSClose',
    'SREPhraseStart', 'SPTEXTSELECTIONINFO', 'SpWaveFormatEx',
    'SVEVoiceChange', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SASFreeBufferSpace', 'ISpeechResourceLoader',
    'SAFT16kHz16BitStereo', 'SVP_15', 'SAFTADPCM_22kHzMono',
    'DISPID_SOTCSetId', 'SGRSTTWord', 'SP_VISEME_18',
    'Speech_StreamPos_RealTime', 'DISPID_SVSVisemeId', 'SPAS_RUN',
    'SPEI_TTS_AUDIO_LEVEL', 'SAFT12kHz16BitStereo',
    'DISPID_SRGCmdLoadFromObject', 'SPVPRI_ALERT', 'DISPID_SGRsItem',
    'SPPS_Verb', 'DISPID_SPPNumberOfElements', 'SpInProcRecoContext',
    'SpeechAudioFormatGUIDWave', 'SPEI_HYPOTHESIS',
    'ISpeechPhraseRules', 'ISpNotifyTranslator',
    'ISpeechLexiconWords', 'DISPID_SWFEFormatTag', 'ISpNotifySink',
    'eLEXTYPE_RESERVED6', 'SSFMOpenForRead', 'SPCT_SLEEP',
    'DISPID_SpeechPhraseAlternate', 'SVP_7',
    'DISPID_SpeechPhraseElements', 'DISPID_SLPs_NewEnum',
    'ISpeechPhraseAlternates', 'SAFTCCITT_uLaw_22kHzMono',
    'ISpeechPhoneConverter', 'SAFT32kHz8BitStereo', 'SECFIgnoreWidth',
    'DISPID_SPPParent', 'SPPS_SuppressWord', 'SpeechLexiconType',
    'SPSUnknown', 'DISPID_SRRTStreamTime', 'DISPID_SPIGrammarId',
    'SPAS_PAUSE', 'SPINTERFERENCE', 'ISequentialStream',
    'ISpStreamFormat', 'SPWT_PRONUNCIATION',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SAFT24kHz16BitStereo',
    'SpeechVoiceSpeakFlags', 'SPEI_MIN_TTS',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRSetPropertyNumber',
    'ISpeechAudioBufferInfo', 'SRTReSent', 'SASClosed',
    'SPSTREAMFORMATTYPE', 'DISPID_SPCPhoneToId', 'SSFMCreateForWrite',
    'SpPhraseInfoBuilder', 'SPINTERFERENCE_NOISE',
    'eLEXTYPE_RESERVED4', 'DISPID_SMSAMMHandle',
    'DISPID_SWFEBlockAlign', 'SP_VISEME_10',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SDKSetBinaryValue',
    'SDA_Consume_Leading_Spaces', 'SPEI_UNDEFINED', 'SVF_Stressed',
    'SpeechRecoEvents', 'SRATopLevel', 'SpeechTokenShellFolder',
    'DISPID_SRGCmdLoadFromMemory', 'SPLO_DYNAMIC', 'SPVISEMES',
    'ISpPhoneConverter', 'DISPID_SVEStreamEnd',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRCEEnginePrivate', 'DISPID_SRGDictationLoad',
    'SAFT44kHz16BitStereo', 'SpeechAudioState', 'SPCATEGORYTYPE',
    'SITooQuiet', 'DISPID_SpeechRecoResult2', 'DISPID_SOTDisplayUI',
    'STSF_FlagCreate', 'SGRSTTWildcard', 'SPAR_Medium', 'SP_VISEME_3',
    'SPWT_DISPLAY', 'DISPID_SRCERequestUI', 'eLEXTYPE_PRIVATE1',
    'SPPHRASEREPLACEMENT', 'DISPID_SVAudioOutput',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SPRText', 'SVF_None', 'DISPID_SRAudioInput',
    'DISPID_SASetState', 'SREPropertyStringChange',
    'DISPID_SpeechAudioFormat', 'SPSERIALIZEDPHRASE',
    'DISPID_SDKGetlongValue', 'SPEI_TTS_PRIVATE', 'DISPID_SAFType',
    'SPEI_SOUND_END', 'SAFTNonStandardFormat', 'DISPID_SOTRemove',
    'DISPID_SVSLastBookmark', 'DISPID_SRCSetAdaptationData',
    'DISPID_SRCERecognizerStateChange', '_ISpeechRecoContextEvents',
    'SVEWordBoundary', 'SpeechLoadOption', 'SPBOOKMARKOPTIONS',
    'SVEBookmark', 'eLEXTYPE_PRIVATE18', 'SpeechAudioVolume',
    'SPPS_Noun', 'SPEI_RESERVED1', 'DISPID_SWFEChannels',
    'SPBINARYGRAMMAR', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SOTCGetDataKey', 'SPAR_High', 'DISPID_SpeechRecognizer',
    'ISpRecognizer3', 'SPEI_END_INPUT_STREAM',
    'DISPID_SVSInputSentencePosition', 'SPGS_DISABLED',
    'ISpeechWaveFormatEx', 'SPPS_Noncontent', 'SPRECOSTATE',
    'SDTAudio', 'ISpeechVoice', 'SPWORDPRONUNCIATION',
    'IEnumSpObjectTokens', 'eLEXTYPE_PRIVATE11', 'DISPID_SRRTLength',
    'SPINTERFERENCE_NONE', 'SpeechRetainedAudioOptions',
    'DISPID_SpeechPhraseRule', 'SRERequestUI', 'SVSFParseMask',
    'DISPID_SRGId', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPEActualConfidence', 'DISPIDSPRG', 'SpInprocRecognizer',
    'eWORDTYPE_DELETED', 'DISPID_SPPs_NewEnum',
    'DISPID_SRCCreateGrammar', 'SPFILEMODE', 'DISPID_SPCIdToPhone',
    'SP_VISEME_6', 'ISpeechPhraseProperties', 'SPWORDPRONOUNCEABLE',
    'DISPID_SVSLastStreamNumberQueued', 'SpNotifyTranslator', 'SVP_4',
    'DISPID_SAStatus', 'SGDSInactive', 'DISPID_SGRSTType',
    'DISPID_SRGRecoContext', 'SREStateChange', 'SVP_9',
    'DISPID_SOTCreateInstance', 'ISpPhrase', 'SDTLexicalForm',
    'ISpeechTextSelectionInformation', 'SPRECOCONTEXTSTATUS',
    'SRTExtendableParse', 'SpeechTokenKeyFiles', 'SRESoundStart',
    'SpeechDictationTopicSpelling', 'SpeechAddRemoveWord',
    'SPEI_SR_PRIVATE', 'SPDKL_CurrentUser',
    'ISpStreamFormatConverter', 'SAFT16kHz8BitStereo',
    'SpeechDataKeyLocation', 'DISPID_SPPValue',
    'DISPID_SOTGetStorageFileName', 'tagSPPROPERTYINFO',
    'DISPID_SPEs_NewEnum', 'DISPID_SRCEPhraseStart',
    'ISpeechPhraseRule', 'SP_VISEME_16', 'DISPID_SLPPhoneIds',
    'SPEI_PHONEME', 'SPEI_INTERFERENCE',
    'SWPUnknownWordPronounceable', 'DISPID_SRGState',
    'SpeechCategoryRecognizers', 'DISPIDSPTSI_ActiveOffset',
    'SPFM_CREATE_ALWAYS', 'SVF_Emphasis', 'DISPID_SPIRule',
    'SRADefaultToActive', 'SpeechAllElements', 'SPEI_RESERVED3',
    'DISPID_SCSBaseStream', 'SAFTExtendedAudioFormat',
    'SAFTCCITT_uLaw_22kHzStereo', 'SRERecognition',
    'DISPID_SpeechVoiceStatus', 'SAFT48kHz8BitStereo',
    'SVSFlagsAsync', 'SP_VISEME_2', 'SAFTADPCM_8kHzMono',
    'DISPID_SpeechPhoneConverter', 'SPPS_Unknown',
    'DISPID_SVSpeakCompleteEvent', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SOTMatchesAttributes', 'DISPID_SPRulesItem',
    'SPINTERFERENCE_TOOFAST', 'SPPS_RESERVED3', 'SRADynamic',
    'ISpLexicon', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SGRInitialState', 'DISPID_SDKSetStringValue',
    'Speech_Max_Word_Length', 'DISPID_SGRAddResource',
    'DISPID_SDKEnumKeys', 'ISpPhoneticAlphabetConverter',
    'SpeechPropertyHighConfidenceThreshold', 'SAFT8kHz16BitStereo',
    'SpMMAudioOut', 'SGSEnabled', 'SVPAlert', 'SSSPTRelativeToEnd',
    'IInternetSecurityMgrSite', 'SECLowConfidence',
    'DISPID_SRGSetTextSelection', 'eLEXTYPE_PRIVATE20',
    'SpMemoryStream', 'SVP_20', 'DISPID_SABufferInfo',
    'DISPID_SLWWord', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRRSpeakAudio', 'DISPID_SPRuleParent', 'SP_VISEME_13',
    'SPEI_VISEME', 'DISPID_SRGetPropertyString', 'SPSHORTCUTTYPE',
    'DISPID_SVSLastResult', 'SVSFDefault', 'SpeechStreamFileMode',
    'SAFTADPCM_11kHzStereo', 'SVP_12', 'SASStop', 'SSTTTextBuffer',
    'ISpStream', 'ISpeechLexiconPronunciations',
    'SpeechSpecialTransitionType', 'DISPID_SRCRetainedAudioFormat',
    'SDTAlternates', 'DISPID_SpeechRecoContext',
    'SRERecoOtherContext', 'SPEI_END_SR_STREAM', 'SVEEndInputStream',
    'SAFT32kHz8BitMono', 'SpeechRecoContextState',
    'DISPID_SLPPartOfSpeech', 'DISPID_SOTCDefault',
    'SAFT32kHz16BitStereo', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SGRSTPropertyName', 'SPAS_STOP',
    'DISPID_SPEAudioTimeOffset',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'eLEXTYPE_PRIVATE9',
    '_RemotableHandle', 'DISPID_SpeechPhraseAlternates',
    'ISpeechObjectTokenCategory', 'SPAR_Low', 'DISPID_SVPriority',
    'DISPID_SRCResume', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SVResume', 'SPBO_TIME_UNITS', 'SpeechTokenValueCLSID',
    'SPEI_MAX_TTS', 'DISPID_SVSkip', 'eLEXTYPE_RESERVED8',
    'SAFT44kHz8BitStereo', 'SDKLCurrentUser',
    'eLEXTYPE_VENDORLEXICON', 'SPRECOGNIZERSTATUS',
    'SPDKL_DefaultLocation', 'ISpeechPhraseProperty',
    'DISPID_SPAsCount', 'SpAudioFormat', 'DISPID_SOTSetId',
    'DISPID_SpeechCustomStream', 'DISPID_SRDisplayUI',
    'DISPID_SRSCurrentStreamPosition', 'ISpeechCustomStream',
    'STSF_LocalAppData', 'DISPID_SRCAudioInInterferenceStatus',
    'SPEI_TTS_BOOKMARK', 'SITooSlow', 'DISPID_SPARecoResult',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SVAudioOutputStream',
    'DISPID_SGRsAdd', 'SpeechPropertyAdaptationOn',
    'SPRST_INACTIVE_WITH_PURGE', 'SLTApp', 'eLEXTYPE_PRIVATE14',
    'SBONone', 'DISPID_SRRTTickCount', 'SPEI_START_INPUT_STREAM',
    'SECNormalConfidence', 'SPSHORTCUTPAIRLIST', 'SRTSMLTimeout',
    'SSFMOpenReadWrite', 'DISPID_SRStatus',
    'ISpeechPhraseReplacements', 'DISPID_SRCEBookmark',
    'ISpeechAudioFormat', 'SpeechGrammarTagWildcard',
    'DISPID_SRSAudioStatus', 'SFTSREngine', 'DISPID_SPAsItem',
    'DISPID_SRRDiscardResultInfo', 'ISpeechRecoResultTimes',
    'DISPID_SWFESamplesPerSec', 'DISPID_SMSGetData',
    'DISPID_SPRules_NewEnum', 'DISPID_SVSRunningState',
    'SP_VISEME_19', 'DISPID_SRCVoicePurgeEvent', 'ISpeechRecoResult2',
    'DISPID_SREmulateRecognition', 'SGRSTTTextBuffer',
    'DISPID_SRCCmdMaxAlternates', 'SAFT48kHz16BitMono',
    'SSSPTRelativeToStart', 'eWORDTYPE_ADDED',
    'SpeechTokenKeyAttributes', 'DISPID_SPIAudioStreamPosition',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SDKLCurrentConfig',
    'DISPID_SPIStartTime', 'STCLocalServer', 'DISPID_SGRName',
    'DISPID_SRGCmdLoadFromResource', 'SRCS_Enabled',
    'DISPID_SPEDisplayText', 'SGDSActiveUserDelimited',
    'DISPID_SPEAudioStreamOffset', 'SpSharedRecognizer',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SPPEngineConfidence',
    'SpObjectToken', 'ISpGrammarBuilder', 'SVP_5',
    'DISPID_SRCEStartStream', 'DISPID_SRGReset',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPRNumberOfElements',
    'eLEXTYPE_PRIVATE17', 'SPCT_SUB_DICTATION',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpRecoGrammar',
    'SAFT48kHz16BitStereo', 'DISPID_SPIReplacements',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpeechWordType',
    'ISpXMLRecoResult', 'DISPID_SDKDeleteKey',
    'SpeechRecognizerState', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SPISaveToMemory', 'SPLOADOPTIONS', 'SpeechRuleState',
    'SPEI_START_SR_STREAM', 'SPPS_Interjection', 'DISPID_SRRTimes',
    'ISpRecognizer', 'DISPID_SpeechMemoryStream',
    ...
    'SVESentenceBoundary', 'SpeechEngineProperties',
    'SpeechEmulationCompareFlags', 'DISPID_SRCRequestedUIType',
    'DISPID_SASNonBlockingIO', 'DISPID_SVAlertBoundary',
    'DISPID_SPACommit', 'SVP_8', 'DISPID_SpeechAudio',
    'eLEXTYPE_PRIVATE8', 'DISPID_SRRSetTextFeedback',
    'DISPID_SpeechDataKey', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SOTCategory', 'DISPID_SABufferNotifySize',
    'DISPID_SLGetGenerationChange', 'SpCustomStream', 'SPBO_AHEAD',
    'DISPID_SAFGetWaveFormatEx', 'SpeechRunState',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SAFT12kHz16BitMono',
    'ISpeechLexiconPronunciation', 'DISPID_SRCESoundEnd',
    'DISPID_SGRs_NewEnum', 'DISPID_SDKCreateKey', 'ISpeechBaseStream',
    'DISPID_SPEPronunciation', 'DISPID_SRCEInterference',
    'DISPID_SABIBufferSize', 'SpeechTokenContext',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPRuleEngineConfidence', 'SREAllEvents', 'SECFIgnoreCase',
    'DISPID_SpeechFileStream', 'SRAExport', 'DISPID_SpeechVoiceEvent',
    'DISPID_SGRId', 'SGDSActive', 'SSSPTRelativeToCurrentPosition',
    'SRAORetainAudio', 'ISpeechLexicon',
    'DISPID_SGRSAddWordTransition', 'SpeechStreamSeekPositionType',
    'DISPID_SDKGetBinaryValue', 'DISPID_SOTsItem',
    'DISPID_SVEEnginePrivate', 'SVP_3', 'DISPID_SpeechLexicon',
    'DISPID_SDKOpenKey', 'DISPID_SGRSTs_NewEnum', 'SpResourceManager',
    'ISpPhoneticAlphabetSelection', 'SPCS_ENABLED', 'ISpRecoResult',
    'SAFT22kHz16BitStereo', 'SPSERIALIZEDRESULT', 'SVSFNLPSpeakPunc',
    'ISpeechPhraseAlternate', 'DISPID_SGRAddState',
    'SpeechGrammarRuleStateTransitionType', 'SpeechRecognitionType',
    'DISPID_SRGCommit', 'DISPID_SVSLastBookmarkId', 'SPEVENT',
    'SPPARTOFSPEECH', 'DISPID_SPRuleId', 'SpMMAudioEnum', 'IStream',
    'eLEXTYPE_PRIVATE15', 'ISpObjectToken', 'eLEXTYPE_USER',
    'ISpeechPhraseElements', 'STCInprocHandler',
    'DISPID_SMSADeviceId', 'DISPID_SpeechPhraseProperties',
    'SpeechRegistryUserRoot', 'ISpDataKey', 'STSF_CommonAppData',
    'SpShortcut', 'SPLEXICONTYPE', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SVIsUISupported', 'SVP_17', 'DISPID_SRGDictationUnload',
    'DISPID_SpeechGrammarRuleState', 'ISpeechRecognizer', 'SPWORD',
    'DISPID_SVVolume', 'eLEXTYPE_RESERVED10', 'ISpeechPhraseElement',
    'SPCONTEXTSTATE', 'eLEXTYPE_PRIVATE7', 'DISPID_SWFEExtraData',
    'SPSFunction', 'SAFTGSM610_22kHzMono', 'SPEI_SENTENCE_BOUNDARY',
    'SAFT22kHz8BitStereo', 'DISPID_SPAPhraseInfo', 'SPWORDLIST',
    'SVEStartInputStream', 'DISPID_SRCPause',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPSHT_OTHER', 'SECFDefault',
    'SpeechDisplayAttributes', 'DISPID_SOTGetDescription',
    'DISPID_SRState', 'DISPID_SVSInputWordPosition',
    'SPXRO_Alternates_SML', 'SPBO_PAUSE', 'DISPID_SLPsItem',
    'SVPNormal', 'SpeechVisemeFeature', 'SpeechAudioFormatType',
    'DISPID_SRRAlternates', 'SAFTCCITT_uLaw_44kHzStereo', 'SITooFast',
    'ISpeechRecoResultDispatch', 'SPEI_RESERVED2', 'SVP_13',
    'SpSharedRecoContext', 'DISPID_SGRSTNextState', 'DISPID_SPPId',
    'DISPID_SpeechPhraseRules', 'eLEXTYPE_PRIVATE3', 'SP_VISEME_20',
    'SPBO_NONE', 'DISPID_SRSCurrentStreamNumber',
    'ISpeechRecoGrammar', 'SVSFIsFilename',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SVEPhoneme',
    'SWPKnownWordPronounceable', 'SECHighConfidence',
    'SpeechVisemeType', 'SPEI_RECOGNITION',
    'DISPID_SRCEPropertyStringChange', 'SDA_One_Trailing_Space',
    'DISPID_SpeechLexiconWord', 'STCRemoteServer', 'ISpShortcut',
    'SPCT_DICTATION', 'DISPID_SRRecognizer', 'DISPID_SVStatus',
    'ISpRecoGrammar2', 'SPVPRIORITY', 'DISPID_SVGetAudioOutputs',
    'ISpeechLexiconWord', 'eLEXTYPE_APP',
    'SPEI_PROPERTY_STRING_CHANGE', 'SGSDisabled', 'DISPID_SVPause',
    'DISPID_SPIEnginePrivateData', 'DISPID_SRProfile',
    'DISPID_SpeechWaveFormatEx', 'SAFTCCITT_ALaw_44kHzMono',
    'SPEI_PHRASE_START', 'DISPID_SPRFirstElement',
    'DISPID_SMSALineId', 'SP_VISEME_0',
    'SpeechPropertyComplexResponseSpeed', 'SAFTCCITT_uLaw_8kHzMono',
    'SPWF_INPUT', 'eLEXTYPE_PRIVATE2', 'SRSActive', 'SP_VISEME_8',
    'SPPS_RESERVED1', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'ISpSerializeState', 'DISPID_SRCESoundStart', 'DISPID_SLPLangId',
    'SpeechAudioProperties', 'SpeechCategoryRecoProfiles', 'ISpVoice',
    'SGSExclusive', 'SpeechRuleAttributes', 'SGDSActiveWithAutoPause',
    'SPRST_INACTIVE', 'SPWAVEFORMATTYPE', 'SP_VISEME_11',
    'SAFT12kHz8BitMono', 'DISPID_SPRDisplayAttributes',
    'SPFM_NUM_MODES', 'SP_VISEME_17', 'DISPID_SVRate',
    'DISPID_SpeechPhraseProperty', 'SRAImport', 'eLEXTYPE_PRIVATE13',
    '_SPAUDIOSTATE', 'DISPID_SWFEBitsPerSample', 'SPAUDIOSTATE',
    'SAFT11kHz16BitMono', 'SVP_0', 'SASPause', 'SVP_16',
    'DISPID_SPRuleName', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SAEventHandle', 'SpStreamFormatConverter',
    'DISPID_SVESentenceBoundary', 'DISPID_SGRsDynamic', 'SP_VISEME_5',
    'SPSMF_SAPI_PROPERTIES', 'SpeechInterference', 'SVEPhoneme',
    'DISPID_SOTIsUISupported', 'DISPID_SRCRetainedAudio',
    'SPEI_MAX_SR', 'SWPUnknownWordUnpronounceable',
    'SpeechGrammarTagDictation', 'SVEAudioLevel', 'SVP_6',
    'SDA_No_Trailing_Space', 'DISPID_SRCEFalseRecognition',
    'SP_VISEME_7', 'SPCT_SUB_COMMAND', 'SpObjectTokenCategory',
    'SpeechPropertyResourceUsage', 'DISPID_SRCEAdaptation',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPEDisplayAttributes', 'SRAInterpreter', 'SDTProperty',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPWT_LEXICAL', 'SVP_1',
    'SPEI_RESERVED5', 'SAFT8kHz8BitMono',
    'DISPID_SLRemovePronunciation', 'DISPID_SLWPronunciations',
    'SPGRAMMARSTATE', 'DISPID_SPIElements', 'DISPID_SVVoice',
    'SRTEmulated', 'Speech_StreamPos_Asap', 'SPEI_REQUEST_UI',
    'SWTAdded', 'ISpeechPhraseInfoBuilder', 'SRTAutopause',
    'ISpObjectTokenCategory', 'SPAUDIOSTATUS',
    'DISPID_SPIRetainedSizeBytes', 'SPPHRASEELEMENT', 'ISpAudio',
    'DISPID_SFSOpen', 'DISPID_SVSpeakStream', 'SpLexicon',
    'SRSInactiveWithPurge', 'SAFT44kHz8BitMono', 'SVP_11',
    'DISPID_SLPSymbolic', 'SWTDeleted', 'SPEI_RESERVED6', 'SVP_21',
    'ISpeechXMLRecoResult', 'DISPID_SPRsItem',
    'DISPID_SPERetainedSizeBytes', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPEVENTENUM', 'SVSFVoiceMask', 'DISPID_SPERetainedStreamOffset',
    'SREStreamStart', 'SPVPRI_OVER', 'DISPID_SPIGetText',
    'DISPID_SPPConfidence', 'DISPID_SDKSetLongValue',
    'eLEXTYPE_PRIVATE5', 'eLEXTYPE_PRIVATE19', 'SVSFPersistXML',
    'SPXMLRESULTOPTIONS', 'SpeechBookmarkOptions',
    'DISPID_SRRAudioFormat', 'SPFM_OPEN_READONLY', 'SGLexical',
    'DISPID_SVEViseme', 'SVP_18', 'DISPID_SGRSTWeight',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SVEAudioLevel',
    'SAFTADPCM_22kHzStereo', 'DISPID_SPIEngineId',
    'DISPID_SRRGetXMLErrorInfo', 'SpFileStream',
    'DISPID_SRCreateRecoContext', 'SpPhoneticAlphabetConverter',
    'SP_VISEME_1', 'ISpRecoCategory', 'SAFTText',
    'ISpeechAudioStatus', 'DISPID_SGRsCommit', 'DISPID_SLGetWords',
    'DISPID_SDKGetStringValue', 'SPXRO_SML',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpeechPropertyResponseSpeed',
    'DISPID_SGRSTransitions', 'DISPID_SRSetPropertyString',
    'DISPID_SPPsCount', 'SDKLDefaultLocation', 'DISPID_SPPName',
    'SPINTERFERENCE_LATENCY_WARNING', 'SBOPause', 'SPAS_CLOSED',
    'DISPID_SPILanguageId', 'SAFTNoAssignedFormat',
    ...
    'ISpObjectWithToken', 'DISPID_SRSSupportedLanguages',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SRGRules',
    'SPSNoun', 'SPEI_FALSE_RECOGNITION', 'SPSMF_UPS',
    'DISPID_SAFSetWaveFormatEx', 'SpMMAudioIn', 'DISPID_SGRSTRule',
    'SFTInput', 'DISPID_SVEWord', 'SAFT11kHz8BitStereo',
    'SAFTADPCM_8kHzStereo', 'SPDATAKEYLOCATION',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SpeechRecoResult', 'SPPS_LMA',
    'SVSFIsXML', 'SRTStandard', 'DISPID_SPANumberOfElementsInResult',
    'SPVPRI_NORMAL', 'STSF_AppData', 'SSTTDictation',
    '_ISpeechVoiceEvents', 'DISPID_SRRPhraseInfo', 'SPEI_ADAPTATION',
    'DISPID_SOTDataKey', 'DISPID_SRGIsPronounceable',
    'SDTPronunciation', 'SPSLMA', 'SREStreamEnd',
    'SpeechCategoryAppLexicons', 'SP_VISEME_12',
    'tagSPTEXTSELECTIONINFO', 'SREAudioLevel', 'SpeechMicTraining',
    'DISPID_SPPsItem', 'DISPID_SRGCmdSetRuleState', 'ISpRecoContext2',
    'SpeechDiscardType', 'DISPID_SRSClsidEngine', 'ISpPhraseAlt',
    'SPRULESTATE', 'DISPID_SpeechGrammarRuleStateTransition',
    'SAFT11kHz8BitMono', 'SDKLLocalMachine', 'SAFT24kHz8BitStereo',
    'SRSActiveAlways', 'SPPHRASERULE', 'SpeechPartOfSpeech',
    'DISPID_SpeechBaseStream', 'SAFTGSM610_8kHzMono', 'SLOStatic',
    'DISPID_SBSWrite', 'SVSFUnusedFlags', 'SVEAllEvents',
    'DISPID_SLPType', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SAVolume', 'ISpRecognizer2', 'DISPID_SVWaitUntilDone',
    'ISpeechGrammarRuleStateTransition', 'SPPHRASEPROPERTY',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRCEAudioLevel',
    'SGPronounciation', 'eLEXTYPE_PRIVATE4', 'SPRULE',
    'SPPS_Modifier', 'DISPID_SOTsCount', 'SpTextSelectionInformation',
    'SpeechRecoProfileProperties', 'SPFM_OPEN_READWRITE',
    'DISPID_SASState', 'SPPROPERTYINFO', 'ISpeechObjectToken',
    'SDTAll', 'ISpeechGrammarRuleStateTransitions',
    'ISpeechRecognizerStatus', 'DISPID_SRCVoice',
    'DISPID_SPAs_NewEnum', 'eLEXTYPE_PRIVATE6',
    'SpeechWordPronounceable', 'DISPID_SABIMinNotification',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SP_VISEME_14',
    'SGRSTTDictation', 'SAFT22kHz8BitMono', 'SAFT12kHz8BitStereo',
    'SPDKL_LocalMachine', 'SITooLoud', 'ISpeechMemoryStream',
    'SVEViseme', 'ISpEventSink', 'IInternetSecurityManager',
    'DISPID_SRSNumberOfActiveRules', 'SVSFNLPMask', 'DISPID_SLWsItem',
    'SPEVENTSOURCEINFO', 'DISPID_SVSCurrentStreamNumber',
    'SAFTCCITT_uLaw_11kHzMono', 'SPAO_NONE', 'SPPS_Function',
    'SPVOICESTATUS', 'DISPID_SVSPhonemeId', 'ISpEventSource',
    'SPRST_ACTIVE', 'DISPID_SPELexicalForm', 'DISPID_SVEStreamStart',
    'SP_VISEME_15', 'DISPID_SVSyncronousSpeakTimeout',
    'ISpeechRecoContext', 'DISPID_SPEsCount', 'DISPID_SVGetProfiles',
    'SPGS_ENABLED', 'DISPID_SRCRecognizer', 'DISPID_SGRSTText',
    'ISpRecoContext', 'SPAO_RETAIN_AUDIO', 'SpStream',
    'eLEXTYPE_MORPHOLOGY', 'SPDKL_CurrentConfig',
    'DISPID_SOTs_NewEnum', 'SAFTGSM610_44kHzMono', 'SPRST_NUM_STATES',
    'SpeechPropertyLowConfidenceThreshold', 'SpeechFormatType',
    'DISPID_SGRSTPropertyId', 'SPGS_EXCLUSIVE', 'ISpeechMMSysAudio',
    'SGRSTTEpsilon', 'DISPID_SOTCEnumerateTokens', 'SINoSignal',
    'DISPID_SpeechLexiconProns',
    'DISPID_SRCERecognitionForOtherContext',
    'SAFTCCITT_ALaw_11kHzMono', 'SAFT8kHz16BitMono', 'SPSModifier',
    'DISPID_SRCState', 'WAVEFORMATEX',
    'DISPID_SRCCreateResultFromMemory', 'SAFTGSM610_11kHzMono',
    'SRCS_Disabled', 'SPEI_MIN_SR', 'SPRS_ACTIVE_USER_DELIMITED',
    'SRSInactive', 'DISPIDSPTSI_ActiveLength', 'DISPID_SGRClear',
    'SASRun', 'SpeechGrammarWordType', 'UINT_PTR',
    'SREFalseRecognition', 'DISPID_SLWs_NewEnum',
    'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SAFT22kHz16BitMono', 'SRSEIsSpeaking', 'LONG_PTR',
    'SREAdaptation', 'SVSFPurgeBeforeSpeak', 'SPPS_RESERVED4',
    'SINoise', 'SpNullPhoneConverter', 'SpeechCategoryAudioOut',
    'SRSEDone', 'SpeechUserTraining', 'SPEI_WORD_BOUNDARY',
    'DISPID_SWFEAvgBytesPerSec', 'ISpeechVoiceStatus', 'SRAONone',
    'SRESoundEnd', 'DISPID_SLWsCount', 'SVSFParseAutodetect',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SBSRead', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFTDefault',
    'DISPID_SRRGetXMLResult', 'SPEI_RECO_STATE_CHANGE',
    'SAFTADPCM_44kHzStereo', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SAFT8kHz8BitStereo', 'SSFMCreate', 'DISPID_SGRSTPropertyValue',
    'DISPID_SLPsCount', 'SPGRAMMARWORDTYPE',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SGRSTsCount',
    'SPCS_DISABLED', 'DISPID_SRCEEndStream',
    'DISPID_SVSInputSentenceLength', 'SPSHORTCUTPAIR',
    'SPAUDIOBUFFERINFO', 'DISPID_SLWLangId', 'ISpeechGrammarRule',
    'SpeechTokenIdUserLexicon', 'DISPID_SAFGuid',
    'eLEXTYPE_RESERVED9', 'DISPID_SpeechGrammarRules',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SRCEHypothesis',
    'DISPID_SpeechPhraseBuilder', 'SPRS_INACTIVE', 'STCInprocServer',
    'DISPID_SRRRecoContext', 'DISPID_SpeechObjectTokens', 'SVPOver',
    'SVP_14', 'ISpeechPhraseReplacement',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SPEAudioSizeTime', 'DISPID_SGRSRule', 'IEnumString',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPRuleChildren',
    'SPEI_SR_BOOKMARK', 'SpeechEngineConfidence', 'SPCT_COMMAND',
    'DISPID_SRCERecognition', 'STCAll', 'DISPID_SGRsCount',
    'SVEPrivate', 'SPADAPTATIONRELEVANCE', 'DISPID_SPIAudioSizeTime',
    'DISPID_SGRSAddRuleTransition', 'tagSTATSTG',
    'DISPID_SGRsCommitAndSave',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SpeechGrammarRule', 'DISPID_SRCEventInterests',
    'ISpeechFileStream', 'eLEXTYPE_PRIVATE12', 'SpeechVoicePriority',
    'DISPID_SVEVoiceChange', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SLGenerationId', 'SPSHT_NotOverriden',
    'SpeechAudioFormatGUIDText', 'SDTDisplayText', 'DISPID_SLWType',
    'SAFTADPCM_44kHzMono', 'DISPID_SGRAttributes', 'SVSFIsNotXML',
    'DISPID_SDKEnumValues', 'ISpeechRecoResult',
    'ISpeechObjectTokens', 'SPSVerb', 'DISPID_SVEventInterests',
    'SDA_Two_Trailing_Spaces', 'DISPID_SOTGetAttribute',
    'DISPID_SPCLangId', 'ISpeechGrammarRules', 'SPPS_RESERVED2',
    'SPSEMANTICERRORINFO', 'DISPID_SBSSeek', 'SAFT32kHz16BitMono',
    'DISPID_SOTCId', 'SpVoice', 'SLODynamic',
    'DISPID_SPEEngineConfidence', 'SPLO_STATIC',
    'DISPID_SpeechObjectToken', 'SP_VISEME_9',
    'DISPID_SpeechPhraseReplacement', 'SPEI_VOICE_CHANGE',
    'SPAUDIOOPTIONS', 'SREPropertyNumChange',
    'SpeechVoiceSkipTypeSentence', 'SP_VISEME_4',
    'SpeechCategoryAudioIn', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SDKDeleteValue', 'DISPID_SPRuleFirstElement',
    'SREPrivate', 'DISPID_SVDisplayUI', 'DISPID_SVGetAudioInputs',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpNotifySource',
    'DISPID_SpeechLexiconPronunciation', 'SAFTCCITT_ALaw_8kHzMono',
    'SAFT44kHz16BitMono', 'ISpResourceManager', 'SPPS_NotOverriden',
    'DISPID_SRGetFormat', 'SECFNoSpecialChars',
    'SAFTCCITT_ALaw_22kHzMono', 'SPAR_Unknown', 'DISPID_SMSSetData',
    'SDTReplacement', 'SAFTCCITT_ALaw_22kHzStereo',
    'SAFT16kHz8BitMono', 'SPRST_ACTIVE_ALWAYS', 'ISpeechPhraseInfo',
    'DISPID_SpeechVoice', 'DISPID_SADefaultFormat',
    'DISPID_SPRuleConfidence', 'DISPID_SPRsCount',
    'DISPID_SRGetRecognizers', 'SPFM_CREATE', 'SVP_19',
    'eLEXTYPE_RESERVED7', 'SVP_10', 'SpeechCategoryVoices',
    'SPSSuppressWord', 'DISPID_SRIsUISupported', 'ISpMMSysAudio',
    'SLTUser', 'SpeechCategoryPhoneConverters', 'SpeechTokenKeyUI',
    'DISPID_SOTId', 'SAFT24kHz16BitMono', 'DISPID_SLAddPronunciation',
    'DISPID_SVEBookmark', 'SAFT48kHz8BitMono'
]
