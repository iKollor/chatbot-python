...
__all__ = [
    'SPGRAMMARSTATE', 'DISPID_SVAudioOutputStream',
    'DISPID_SRCERecognitionForOtherContext',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPACommit',
    'SpeechAllElements', 'DISPID_SDKSetBinaryValue',
    'DISPID_SpeechGrammarRules', 'SSFMCreateForWrite',
    'SAFT32kHz8BitMono', 'SAFT8kHz8BitStereo', 'SAFT12kHz8BitMono',
    'ISpProperties', 'DISPID_SpeechVoiceStatus', 'DISPID_SRIsShared',
    'DISPID_SRCEventInterests', 'DISPID_SRCEInterference',
    'DISPID_SVESentenceBoundary', 'SpStream',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRRSpeakAudio', 'SVP_4',
    'ISpeechPhraseElements', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SpeechPhraseRule', 'DISPID_SCSBaseStream',
    'DISPID_SOTCGetDataKey', 'SPWT_PRONUNCIATION', 'SPRS_ACTIVE',
    'SGRSTTWildcard', 'SPRULESTATE', 'SVEAllEvents', 'SVP_16',
    'DISPID_SGRSRule', 'ISpeechRecoGrammar', 'SRSEDone',
    'ISpeechCustomStream', 'DISPID_SpeechFileStream',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SpeechCustomStream',
    'SPAR_Medium', 'eLEXTYPE_PRIVATE14', 'SPEVENTENUM', 'DISPIDSPTSI',
    'SpPhoneConverter', 'SPXRO_SML', 'DISPID_SGRSTRule',
    'DISPID_SpeechPhraseBuilder', 'SPAUDIOSTATUS', 'SPCT_COMMAND',
    'ISpeechLexiconPronunciations', 'DISPID_SOTRemove',
    'DISPID_SpeechPhraseAlternates', 'ISpeechPhraseElement', 'SVP_15',
    'SpeechInterference', 'DISPID_SRGReset', 'SASClosed',
    'ISpeechXMLRecoResult', 'SPEI_START_SR_STREAM', 'SPEI_RESERVED5',
    'SPCS_DISABLED', 'SAFT48kHz8BitMono', 'SPXMLRESULTOPTIONS',
    'SVPNormal', 'DISPID_SREmulateRecognition', 'SVF_None',
    'SPAR_Unknown', 'SRAExport', 'DISPID_SOTDisplayUI',
    'SPGS_ENABLED', 'DISPID_SRGState', 'DISPID_SRGetPropertyString',
    'DISPID_SLRemovePronunciation', 'SAFT8kHz16BitStereo',
    'SPRST_ACTIVE', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SPRuleChildren', 'DISPID_SDKGetStringValue',
    'SAFTGSM610_44kHzMono', 'DISPID_SVGetAudioInputs',
    'ISpStreamFormat', 'DISPID_SLGetPronunciations',
    '_RemotableHandle', 'SPEI_SR_BOOKMARK', 'DISPID_SOTCId',
    'DISPID_SpeechWaveFormatEx',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SASState',
    'SP_VISEME_17', 'DISPID_SRRTTickCount', 'SRAORetainAudio',
    'SAFTDefault', 'ISpeechAudio', 'SPWT_DISPLAY', 'SVSFIsXML',
    'SpeechGrammarTagWildcard', 'ISpeechRecognizer',
    'DISPID_SpeechVoiceEvent', 'DISPID_SOTs_NewEnum',
    'SPSTREAMFORMATTYPE', 'SAFT24kHz8BitMono', 'SVP_8', 'SPSModifier',
    'DISPID_SRCResume', 'SPEI_RESERVED6',
    'DISPID_SPIRetainedSizeBytes', 'ISpeechPhraseAlternate',
    'DISPID_SGRSTsItem', 'DISPID_SAFGuid', 'SpeechAudioState',
    'DISPID_SPPsCount', 'SpeechCategoryAudioOut',
    'SpeechPropertyComplexResponseSpeed', 'SAFT12kHz8BitStereo',
    'SPPS_LMA', 'SP_VISEME_10', 'SpWaveFormatEx',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpResourceManager', 'SPRECOCONTEXTSTATUS', 'SSSPTRelativeToEnd',
    'DISPID_SOTGetDescription', 'DISPID_SRSNumberOfActiveRules',
    'SDKLDefaultLocation', 'SAFT32kHz8BitStereo', 'SRCS_Disabled',
    'SRTSMLTimeout', 'SPBO_TIME_UNITS', 'SGDisplay',
    'DISPID_SGRSTText', 'SSFMOpenReadWrite',
    'DISPID_SPEPronunciation', 'DISPID_SGRs_NewEnum',
    'ISpeechRecoContext', 'DISPID_SMSADeviceId', 'DISPID_SPRuleName',
    'SpeechRuleAttributes', 'DISPID_SPPEngineConfidence',
    'eLEXTYPE_RESERVED10', 'SPAUDIOSTATE', 'DISPID_SGRInitialState',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVP_6',
    'DISPID_SRProfile', 'DISPID_SGRAddResource', 'SSFMCreate',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SRRAlternates',
    'ISpeechMMSysAudio', 'eLEXTYPE_PRIVATE8', 'SVP_17',
    'SAFT48kHz8BitStereo', 'SGDSActive', 'ISpPhraseAlt',
    'eLEXTYPE_PRIVATE10', 'SpNullPhoneConverter', 'DISPID_SLWsItem',
    'DISPID_SDKEnumValues', 'DISPID_SpeechLexiconPronunciation',
    'SRTAutopause', 'SINoise', 'SRERequestUI',
    'ISpObjectTokenCategory', 'DISPID_SVAlertBoundary',
    'DISPID_SVPause', 'DISPID_SOTDataKey', 'ISpRecoGrammar',
    'DISPID_SRGCmdSetRuleState', 'eLEXTYPE_PRIVATE16',
    'SSFMOpenForRead', 'SPSVerb', 'ISpeechGrammarRuleState',
    'DISPID_SPPFirstElement', 'DISPID_SRGRecoContext', 'ISpStream',
    'SpeechDataKeyLocation', 'DISPID_SRGIsPronounceable',
    'DISPID_SpeechRecoContext', 'SVEBookmark',
    'DISPID_SRRRecoContext', 'DISPID_SRAudioInput', 'SSTTDictation',
    'SPWORDLIST', 'DISPID_SLPPartOfSpeech', 'DISPID_SVAudioOutput',
    'SITooFast', 'DISPID_SPEActualConfidence',
    'DISPID_SRCSetAdaptationData', 'SINoSignal',
    'DISPID_SVSLastResult', 'SGRSTTTextBuffer', 'STSF_AppData',
    'SPCT_DICTATION', 'SPEI_RESERVED3', 'SRADefaultToActive',
    'SpeechAudioProperties', 'SAFT12kHz16BitMono',
    'DISPID_SMSGetData', 'DISPID_SVSRunningState', 'SP_VISEME_5',
    'DISPID_SGRsFindRule', 'SVEAudioLevel', 'DISPID_SPAPhraseInfo',
    'DISPID_SRRTOffsetFromStart', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRCBookmark', 'DISPIDSPTSI_SelectionLength',
    'ISpeechGrammarRuleStateTransitions', 'SpStreamFormatConverter',
    'DISPID_SRGDictationUnload', 'SVSFVoiceMask',
    'SAFT12kHz16BitStereo', 'SLTApp', 'eLEXTYPE_PRIVATE3',
    'DISPID_SVSInputSentenceLength', 'SAFT24kHz16BitMono',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpeechPartOfSpeech',
    'DISPID_SVSInputSentencePosition', 'DISPID_SpeechPhraseElements',
    'DISPID_SRCEAdaptation', 'SPEI_START_INPUT_STREAM',
    'DISPID_SPARecoResult', 'SpInProcRecoContext',
    'DISPID_SRCEEndStream', 'DISPID_SPRuleFirstElement',
    'SpCompressedLexicon', 'SPVPRI_OVER', 'STSF_CommonAppData',
    'DISPID_SDKOpenKey', 'WAVEFORMATEX', 'SPEI_PHRASE_START',
    'DISPID_SPAsItem', 'ISpeechLexiconPronunciation',
    'DISPID_SVEViseme', 'DISPID_SRCRecognizer',
    'DISPID_SABIEventBias', 'eWORDTYPE_DELETED',
    'DISPID_SPIReplacements', 'DISPID_SpeechDataKey',
    'SAFTNonStandardFormat', 'SpeechEngineConfidence',
    'SDTLexicalForm', 'SSSPTRelativeToStart', 'SVF_Emphasis',
    'DISPID_SVGetProfiles', 'DISPID_SBSSeek', 'SPPS_Function',
    'DISPID_SVSpeakStream', 'SPPS_RESERVED4',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SRGetFormat',
    'DISPID_SPAs_NewEnum', 'SpObjectTokenCategory', 'SVP_12',
    'SpeechUserTraining', 'SGRSTTEpsilon', 'SRTReSent',
    'DISPID_SRSetPropertyString', 'DISPID_SPRsCount', 'SPLO_STATIC',
    'SVSFNLPSpeakPunc', 'SPPS_SuppressWord', 'SpLexicon',
    'DISPID_SPPConfidence', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechTokenKeyFiles', 'eWORDTYPE_ADDED', 'SpSharedRecognizer',
    'DISPID_SVRate', 'eLEXTYPE_MORPHOLOGY',
    'SpeechRecoProfileProperties', 'DISPID_SPEDisplayText',
    'DISPID_SpeechLexiconWord', 'SAFTCCITT_uLaw_44kHzStereo',
    'SpMMAudioIn', 'SPEI_RESERVED1', 'SpeechPropertyResponseSpeed',
    'SAFTGSM610_22kHzMono', 'DISPID_SDKCreateKey',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SRRGetXMLResult',
    'SpeechTokenKeyAttributes', 'SpeechVoiceSpeakFlags',
    'DISPID_SVGetAudioOutputs', 'DISPID_SRSCurrentStreamNumber',
    'SP_VISEME_20', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SPRuleNumberOfElements', 'SECFEmulateResult',
    'SPPS_RESERVED2', 'DISPID_SRCState', 'DISPID_SVIsUISupported',
    'DISPID_SGRSTNextState', 'DISPID_SpeechRecognizerStatus',
    'eLEXTYPE_PRIVATE4', 'SPVPRI_ALERT', 'SBOPause',
    'SGRSTTDictation', 'SP_VISEME_8', 'STCAll',
    'DISPID_SPEEngineConfidence', 'ISpMMSysAudio',
    'SAFTADPCM_8kHzMono', 'ISpeechResourceLoader',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechObjectTokens',
    'DISPID_SPIRule', 'DISPID_SRRTimes', 'DISPID_SRCEBookmark',
    '_ISpeechRecoContextEvents', 'SpFileStream', 'DISPID_SRRAudio',
    'SPFM_OPEN_READONLY',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpeechPhoneConverter', 'DISPID_SOTGetAttribute',
    'DISPID_SOTCreateInstance', 'SPAS_STOP', 'SpUnCompressedLexicon',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SBSFormat', 'DISPID_SPPId',
    'SAFTNoAssignedFormat', 'SVP_13', 'SPSMF_UPS',
    'SPPS_NotOverriden', 'DISPID_SPIProperties', 'SVEViseme',
    'SPEI_PHONEME', 'ISpRecoContext', 'DISPID_SRSSupportedLanguages',
    'SAFT16kHz16BitMono', 'ISpNotifySource', 'SLTUser',
    'DISPID_SpeechPhraseElement', 'SPPS_Unknown', 'STCRemoteServer',
    'STSF_LocalAppData', 'SpeechTokenShellFolder', 'SFTInput',
    'ISpeechRecognizerStatus', 'DISPID_SGRSTransitions',
    'SPEI_SOUND_START', 'SpeechCategoryAudioIn', 'SAFTText',
    'DISPID_SPRules_NewEnum', 'SpeechSpecialTransitionType',
    'DISPID_SPPs_NewEnum', 'SPPS_RESERVED3', 'eLEXTYPE_PRIVATE9',
    'SSTTWildcard', 'SECFIgnoreWidth', 'SRADynamic', 'SPPS_Verb',
    'SPEI_END_SR_STREAM', 'ISpPhoneConverter',
    'SDA_Consume_Leading_Spaces', 'IInternetSecurityMgrSite',
    'DISPID_SGRSAddWordTransition', 'DISPID_SPIEngineId',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpRecognizer',
    '_ISpeechVoiceEvents', 'SPFM_NUM_MODES', 'DISPID_SAStatus',
    'SRSInactiveWithPurge', 'SREPropertyStringChange',
    'DISPID_SGRsCount', 'DISPID_SLWWord', 'DISPID_SPILanguageId',
    'SPAS_PAUSE', 'DISPID_SWFEChannels', 'DISPID_SVSLastBookmarkId',
    'SPSUnknown', 'DISPID_SGRSTWeight', 'SPSMF_SAPI_PROPERTIES',
    'SPSHORTCUTPAIR', 'SPVOICESTATUS', 'SAFTCCITT_uLaw_22kHzMono',
    'eLEXTYPE_RESERVED6', 'SPINTERFERENCE', 'DISPID_SPAsCount',
    'SpeechRecognitionType', 'SPCT_SUB_COMMAND', 'SPEVENTSOURCEINFO',
    'tagSPPROPERTYINFO', 'SAFTCCITT_ALaw_44kHzStereo',
    'SECHighConfidence', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SPIEnginePrivateData', 'SPAR_High', 'SpeechGrammarState',
    'SpeechAudioVolume', 'DISPID_SOTIsUISupported',
    'DISPID_SRGCmdSetRuleIdState', 'SECLowConfidence',
    'DISPID_SLPLangId', 'SpeechEmulationCompareFlags',
    'DISPID_SWFEAvgBytesPerSec', 'SPEI_REQUEST_UI', 'IStream',
    'DISPID_SpeechMMSysAudio', 'SREPrivate',
    'DISPID_SVSCurrentStreamNumber', 'SpeechDiscardType',
    'SWPUnknownWordPronounceable', 'DISPID_SMSAMMHandle',
    'DISPID_SLGenerationId', 'DISPID_SRCreateRecoContext',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SGRsCommit',
    'DISPID_SRSClsidEngine', 'ISpXMLRecoResult', 'DISPID_SVGetVoices',
    'SpeechWordType', 'DISPID_SRGCmdLoadFromFile',
    'SpeechCategoryVoices', 'SRARoot', 'SAFT32kHz16BitStereo',
    'SRSActive', 'DISPID_SpeechRecoResult2', 'DISPID_SLPType',
    'ISpeechObjectTokenCategory', 'SECNormalConfidence',
    'SPEI_TTS_PRIVATE', 'SLODynamic', 'SpeechAudioFormatGUIDWave',
    'SREStateChange', 'DISPID_SpeechAudioBufferInfo', 'DISPIDSPRG',
    'SPINTERFERENCE_TOOFAST', 'ISpRecognizer2', 'STCInprocHandler',
    'SAFTADPCM_22kHzMono', 'eLEXTYPE_RESERVED7', 'SpAudioFormat',
    'SpeechAudioFormatType', 'SAFTCCITT_ALaw_44kHzMono',
    'SVF_Stressed', 'SAFTADPCM_22kHzStereo',
    'DISPID_SpeechPhraseProperties', 'DISPID_SPRulesItem',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SLGetGenerationChange',
    'SPINTERFERENCE_NONE', 'SP_VISEME_19', 'DISPID_SRRTLength',
    'DISPID_SRCVoice', 'SGDSActiveWithAutoPause',
    'DISPID_SVEAudioLevel', 'SPINTERFERENCE_TOOSLOW',
    'ISpeechGrammarRules', 'SDKLCurrentConfig', 'DISPID_SLWs_NewEnum',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPRulesCount',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SMSSetData',
    'DISPID_SDKEnumKeys', 'SREStreamEnd', 'SRESoundStart',
    'DISPID_SADefaultFormat', 'SpeechStreamFileMode', 'SVPAlert',
    'SRERecognition', 'ISpeechLexicon', 'SAFT24kHz16BitStereo',
    'SAFT44kHz16BitStereo', 'SPRST_NUM_STATES',
    'SPADAPTATIONRELEVANCE', 'eLEXTYPE_PRIVATE2', 'SPAO_RETAIN_AUDIO',
    'SPSHT_EMAIL', 'SpeechLoadOption', 'SREAdaptation',
    'SPSEMANTICERRORINFO', 'SDA_Two_Trailing_Spaces',
    'SSTTTextBuffer', 'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SLGetWords',
    '__MIDL_IWinTypes_0009', 'eLEXTYPE_PRIVATE5',
    'SREFalseRecognition', 'DISPID_SPPName', 'ISpRecoGrammar2',
    'DISPIDSPTSI_ActiveLength', 'SVP_0',
    'ISpeechGrammarRuleStateTransition', 'SPLOADOPTIONS',
    'DISPID_SVStatus', 'SAFTADPCM_11kHzMono',
    'DISPID_SVSyncronousSpeakTimeout', 'Speech_Max_Pron_Length',
    'DISPID_SOTCEnumerateTokens', 'SBONone', 'SPEI_VOICE_CHANGE',
    'DISPID_SABIBufferSize', 'SPEVENT', 'DISPID_SPPChildren',
    'SPLO_DYNAMIC', 'DISPID_SpeechObjectTokens',
    'SDA_No_Trailing_Space', 'SVESentenceBoundary', 'SASStop',
    'ISpeechLexiconWord', 'DISPID_SRGSetWordSequenceData',
    'SPEI_RECO_OTHER_CONTEXT', 'SP_VISEME_4',
    'SpeechDisplayAttributes', 'SRATopLevel', 'DISPID_SRStatus',
    'DISPID_SPRNumberOfElements', 'SAFTGSM610_8kHzMono',
    'SpeechVoiceEvents', 'SVEVoiceChange', 'SAFT22kHz16BitStereo',
    'SITooLoud', 'SAFT8kHz16BitMono', 'eLEXTYPE_PRIVATE1',
    'SPCATEGORYTYPE', 'DISPID_SWFEBitsPerSample', 'SPSInterjection',
    'SAFT48kHz16BitMono', 'SpeechPropertyLowConfidenceThreshold',
    'SP_VISEME_7', 'SpPhraseInfoBuilder', 'DISPID_SPRFirstElement',
    'DISPID_SAEventHandle', 'SP_VISEME_1', 'ISpRecoCategory',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechMemoryStream',
    'DISPID_SRCERecognition', 'SPINTERFERENCE_TOOLOUD',
    'ISpeechAudioFormat', 'SAFTCCITT_uLaw_44kHzMono',
    'SPRST_INACTIVE', 'DISPID_SRGetPropertyNumber',
    'DISPID_SOTGetStorageFileName', 'SpeechRecognizerState',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SDKDeleteKey',
    'DISPID_SGRSAddSpecialTransition', 'SREAllEvents', 'SPSLMA',
    'SDTProperty', 'SPRECOGNIZERSTATUS', 'tagSTATSTG', 'ISpAudio',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SVSInputWordPosition',
    'DISPID_SPAStartElementInResult', 'DISPID_SVEWord', 'ISpLexicon',
    'SpeechCategoryRecognizers', 'DISPID_SLWsCount',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SP_VISEME_11', 'STCInprocServer',
    'SVP_11', 'SP_VISEME_15', 'LONG_PTR',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SPIGrammarId',
    'SPSERIALIZEDRESULT', 'SPEI_TTS_BOOKMARK', 'SPXRO_Alternates_SML',
    'SAFT11kHz8BitMono', 'SpeechCategoryRecoProfiles',
    'SPEI_PROPERTY_STRING_CHANGE', 'SREPhraseStart', 'SPPARTOFSPEECH',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPEI_INTERFERENCE',
    'DISPID_SpeechAudioStatus', 'SPWORDTYPE',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SGRAttributes',
    'ISpeechLexiconWords', 'DISPID_SRCERequestUI',
    'SpeechAddRemoveWord', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPGS_DISABLED', 'ISpRecoResult', 'DISPID_SpeechVoice',
    'DISPID_SMSALineId', 'SVSFlagsAsync', 'ISpeechRecoResultDispatch',
    'SpPhoneticAlphabetConverter', 'SAFT8kHz8BitMono',
    'SAFT44kHz16BitMono', 'SPCONTEXTSTATE', 'SREInterference',
    'SAFT16kHz8BitMono', 'DISPID_SLPs_NewEnum', 'SPSHORTCUTTYPE',
    'SVPOver', 'DISPID_SpeechPhraseAlternate', 'SpMMAudioEnum',
    'DISPID_SpeechObjectToken', 'ISpeechPhraseReplacements',
    'SPBOOKMARKOPTIONS', 'SVSFUnusedFlags', 'DISPID_SpeechLexicon',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SP_VISEME_0',
    'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpShortcut',
    'DISPID_SpeechRecognizer', 'SVSFNLPMask', 'SITooQuiet',
    'DISPID_SRCRequestedUIType', 'DISPID_SAVolume',
    'ISpeechRecoResult', 'SPSNoun', 'SpNotifyTranslator',
    'ISpNotifyTranslator', 'SAFT22kHz16BitMono',
    'SPINTERFERENCE_NOISE', 'SVSFParseMask', 'ISpEventSource',
    'SPPHRASERULE', 'SPBO_PAUSE', 'SVEStartInputStream',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPSEMANTICFORMAT',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SAFTCCITT_ALaw_8kHzStereo',
    'SVSFPersistXML', 'SpeechVoicePriority', 'DISPID_SGRClear',
    'SpeechRuleState', 'SpeechVisemeFeature', 'SRSActiveAlways',
    'SVEPhoneme', 'SREHypothesis', 'DISPID_SRSAudioStatus',
    'DISPID_SGRAddState', 'SpeechTokenKeyUI', 'SGSEnabled',
    'ISpeechPhraseInfo', 'SVP_1', 'Speech_Default_Weight',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SLWType',
    'SPEI_MAX_SR', 'DISPID_SOTsCount', 'DISPID_SABufferInfo',
    'DISPID_SRCRetainedAudioFormat', 'SpMemoryStream',
    'DISPID_SPIAudioSizeTime', 'DISPID_SVSpeak',
    'DISPID_SAFGetWaveFormatEx', 'SWPUnknownWordUnpronounceable',
    'DISPID_SPPNumberOfElements',
    'DISPID_SPANumberOfElementsInResult', 'SP_VISEME_21',
    'ISpeechObjectToken', 'DISPID_SVSLastBookmark',
    'DISPID_SPISaveToMemory', 'SAFTCCITT_uLaw_8kHzMono',
    'SPRS_ACTIVE_USER_DELIMITED', '_SPAUDIOSTATE',
    'DISPID_SVEStreamEnd', 'STSF_FlagCreate', 'SAFT44kHz8BitStereo',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFTADPCM_44kHzStereo',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SVSInputWordLength',
    'DISPID_SGRSTsCount', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPGRAMMARWORDTYPE',
    'SPFM_CREATE_ALWAYS', 'SPEI_SENTENCE_BOUNDARY',
    'SPDKL_LocalMachine', 'DISPID_SVResume',
    'ISpPhoneticAlphabetConverter', 'SPDKL_CurrentUser',
    'SPRS_INACTIVE', 'eLEXTYPE_RESERVED8', 'SRSInactive',
    'DISPID_SRRSaveToMemory', 'SPEI_HYPOTHESIS', 'SpeechMicTraining',
    'DISPID_SRCRetainedAudio', 'DISPID_SpeechLexiconProns',
    'SpResourceManager', 'SpeechGrammarTagDictation',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRCERecognizerStateChange',
    'UINT_PTR', 'DISPID_SLWPronunciations', 'DISPID_SRCCreateGrammar',
    'eLEXTYPE_APP', 'DISPID_SpeechMemoryStream',
    'SAFTADPCM_44kHzMono', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechRetainedAudioOptions', 'ISpeechWaveFormatEx',
    'IEnumSpObjectTokens', 'DISPIDSPTSI_ActiveOffset',
    'SpeechCategoryPhoneConverters', 'SITooSlow', 'SPCT_SLEEP',
    'SRSEIsSpeaking', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SVVoice', 'SpeechPropertyAdaptationOn',
    'DISPID_SRRSetTextFeedback', 'DISPID_SVWaitUntilDone',
    'SPEI_FALSE_RECOGNITION', 'SPVISEMES', 'eLEXTYPE_PRIVATE18',
    'SP_VISEME_3', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SOTCategory',
    'DISPID_SGRSTType', 'SpeechWordPronounceable',
    'DISPID_SLPPhoneIds', 'SVEPrivate', 'SPSHT_OTHER',
    'DISPID_SDKSetStringValue', 'SpeechRecoContextState',
    'eLEXTYPE_PRIVATE13', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SLPsItem', 'DISPID_SBSRead', 'DISPID_SPEAudioSizeTime',
    'SGDSInactive', 'SpInprocRecognizer', 'SVEWordBoundary',
    'SPGS_EXCLUSIVE', 'SPAS_RUN', 'DISPID_SGRSTPropertyId',
    'eLEXTYPE_PRIVATE17', 'DISPID_SASFreeBufferSpace', 'SRESoundEnd',
    'DISPID_SWFESamplesPerSec', 'SpeechBookmarkOptions',
    'DISPID_SRGCmdLoadFromResource', 'SAFT32kHz16BitMono',
    'DISPID_SRDisplayUI', 'DISPID_SFSOpen',
    'ISpeechTextSelectionInformation', 'ISpObjectToken',
    'SPBINARYGRAMMAR', 'SPFILEMODE', 'DISPID_SPELexicalForm',
    'ISpEventSink', 'DISPID_SPCPhoneToId', 'DISPID_SVDisplayUI',
    'SPEI_RECO_STATE_CHANGE', 'SAFT44kHz8BitMono', 'SP_VISEME_2',
    'SDTDisplayText', 'SPLEXICONTYPE', 'SP_VISEME_18', 'SDTAll',
    'DISPID_SpeechPhraseInfo', 'SVP_14', 'SPWORDPRONOUNCEABLE',
    'eLEXTYPE_PRIVATE7', 'SPSHT_NotOverriden', 'SAFT11kHz16BitMono',
    'ISpGrammarBuilder', 'ISpeechPhraseRule', 'SPPHRASE',
    'SpMMAudioOut', 'DISPID_SRState', 'DISPID_SPEAudioSizeBytes',
    'SpeechGrammarRuleStateTransitionType', 'SPEI_WORD_BOUNDARY',
    'SAFT16kHz8BitStereo', 'SAFTCCITT_ALaw_11kHzStereo', 'SGRSTTRule',
    'DISPID_SGRsCommitAndSave', 'SpTextSelectionInformation',
    'DISPID_SPIAudioStreamPosition', 'SpeechCategoryAppLexicons',
    'ISpeechRecoResultTimes', 'DISPID_SOTSetId', 'SVP_9',
    'SPAUDIOOPTIONS', 'SP_VISEME_9', 'DISPID_SVEventInterests',
    'DISPID_SDKDeleteValue', 'DISPID_SLWLangId', 'SDTAudio',
    'SPEI_RECOGNITION', 'SLOStatic', 'SPFM_OPEN_READWRITE',
    'SPFM_CREATE', 'SPRULE', 'DISPID_SpeechRecoResultTimes',
    'SPAUDIOBUFFERINFO', 'SGPronounciation', 'SPVPRIORITY',
    'SPEI_TTS_AUDIO_LEVEL', 'ISpRecognizer3',
    'DISPID_SRGetRecognizers', 'SPPROPERTYINFO', 'SpeechFormatType',
    'DISPID_SPEsItem', 'SRTStandard', 'SP_VISEME_16',
    'DISPID_SpeechBaseStream', 'SpSharedRecoContext',
    'DISPID_SGRSTPropertyValue', 'IInternetSecurityManager',
    'SGRSTTWord', 'DISPID_SGRSTPropertyName',
    'DISPID_SPRDisplayAttributes', 'DISPID_SWFEFormatTag',
    'DISPID_SRGCmdLoadFromObject', 'SpeechStreamSeekPositionType',
    'DISPID_SpeechObjectTokenCategory', 'SpeechVisemeType',
    'DISPID_SRAudioInputStream', 'ISpeechPhraseReplacement',
    'SpVoice', 'SPDATAKEYLOCATION', 'ISpeechAudioBufferInfo',
    'DISPID_SPIGetDisplayAttributes', 'SPWAVEFORMATTYPE',
    'SpeechLexiconType', 'SpeechRecoEvents',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SGRsItem',
    'SPTEXTSELECTIONINFO', 'ISpeechVoiceStatus', 'SP_VISEME_13',
    'SPEI_MIN_SR', 'SECFNoSpecialChars', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SVSPhonemeId', 'SAFT11kHz8BitStereo',
    'SDA_One_Trailing_Space', 'DISPID_SRRecognizer',
    'DISPID_SOTsItem', 'DISPID_SVEVoiceChange', 'SP_VISEME_12',
    'DISPID_SLAddPronunciation', 'SECFIgnoreKanaType',
    'DISPID_SPIGetText', 'DISPID_SPRsItem', 'SAFTADPCM_11kHzStereo',
    'DISPID_SPRuleConfidence', 'DISPID_SGRsDynamic',
    'ISpSerializeState', 'SVP_3', 'eLEXTYPE_USER',
    'DISPID_SRRTStreamTime', 'SVP_10', 'SPRST_ACTIVE_ALWAYS',
    'ISpObjectWithToken', 'SRAONone', 'SPVPRI_NORMAL',
    'DISPID_SPERequiredConfidence', 'DISPID_SpeechPhoneConverter',
    'SVSFParseSsml', 'DISPID_SPRuleId', 'ISpVoice', 'SVP_19',
    'SVSFParseSapi', 'DISPID_SPEsCount', 'DISPID_SPRText',
    'DISPID_SASetState', 'SPPS_Noncontent', 'DISPID_SLPsCount',
    'DISPID_SPERetainedStreamOffset', 'SPEI_MAX_TTS', 'SpObjectToken',
    'DISPID_SVPriority', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRSetPropertyNumber', 'SPSSuppressWord',
    'SRTExtendableParse', 'eLEXTYPE_PRIVATE11', 'SPEI_UNDEFINED',
    'SP_VISEME_6', 'DISPID_SDKGetlongValue', 'DISPID_SRCEPhraseStart',
    'DISPID_SAFType', 'SpeechTokenContext', 'DISPID_SOTId',
    'DISPID_SPRuleParent', 'SPRECORESULTTIMES', 'SDTAlternates',
    'SpeechRunState', 'SRAImport', 'DISPID_SpeechLexiconWords',
    'DISPID_SPPsItem', 'DISPID_SRCEEnginePrivate', 'SPWF_SRENGINE',
    'SREAudioLevel', 'eLEXTYPE_RESERVED9', 'DISPID_SOTCDefault',
    'DISPID_SASNonBlockingIO', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SRGRules', 'SAFT11kHz16BitStereo',
    'SWPKnownWordPronounceable',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SRCS_Enabled',
    'SPEI_SOUND_END', 'DISPID_SVSVisemeId',
    'SpeechAudioFormatGUIDText', 'DISPID_SRGCmdLoadFromMemory',
    'SPAR_Low', 'ISpeechPhraseAlternates',
    'DISPID_SOTMatchesAttributes', 'DISPID_SWFEBlockAlign',
    'SPPHRASEPROPERTY', 'SPEI_VISEME', 'SPDKL_CurrentConfig',
    'SPEI_ADAPTATION', 'SPWORD', 'SpeechDictationTopicSpelling',
    'SpCustomStream', 'DISPID_SPPValue', 'SINone',
    'DISPID_SDKSetLongValue', 'SPPHRASEREPLACEMENT', 'SECFIgnoreCase',
    'DISPID_SPERetainedSizeBytes', 'SPBO_AHEAD',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPAS_CLOSED',
    'ISpeechBaseStream', 'SPPS_Interjection', 'SPSNotOverriden',
    'SVSFParseAutodetect', 'SPWT_LEXICAL', 'eLEXTYPE_RESERVED4',
    'eLEXTYPE_PRIVATE6', 'DISPID_SABIMinNotification',
    'SRAInterpreter', 'DISPID_SGRsAdd', 'DISPID_SRRGetXMLErrorInfo',
    'SPCT_SUB_DICTATION', 'ISpeechPhraseProperties',
    'ISpPhoneticAlphabetSelection', 'DISPID_SRCCmdMaxAlternates',
    'SAFTCCITT_uLaw_11kHzMono', 'SVSFIsFilename',
    'SAFTADPCM_8kHzStereo', 'ISpeechVoice', 'SASRun',
    'SAFT48kHz16BitStereo', 'SGDSActiveUserDelimited',
    'DISPID_SRCESoundStart', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SDKGetBinaryValue', 'SWTAdded', 'DISPID_SBSWrite',
    'DISPID_SLPSymbolic', 'ISequentialStream', 'SVP_7',
    'Speech_StreamPos_Asap', 'DISPID_SVEPhoneme',
    'DISPID_SPPBRestorePhraseFromMemory', 'eLEXTYPE_PRIVATE19',
    'SPPS_Noun', 'SVSFPurgeBeforeSpeak', 'DISPID_SpeechRecoResult',
    'SpeechTokenValueCLSID', 'DISPID_SRGId',
    'DISPID_SpeechGrammarRule', 'SVP_20', 'ISpRecoContext2',
    'SRERecoOtherContext', 'SPEI_END_INPUT_STREAM',
    'DISPID_SPRs_NewEnum', 'DISPID_SRCEStartStream',
    'DISPID_SPEs_NewEnum', 'SAFTCCITT_ALaw_22kHzMono', 'SDTRule',
    'DISPID_SOTCSetId', 'SAFTGSM610_11kHzMono', 'SPEI_SR_PRIVATE',
    'SPRECOSTATE', 'SREBookmark', 'SPSHT_Unknown',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SpeechAudioFormat',
    'DISPID_SGRSTs_NewEnum', 'SPSFunction', 'SFTSREngine',
    'DISPID_SRGDictationLoad', 'ISpeechDataKey',
    'DISPIDSPTSI_SelectionOffset', 'IEnumString', 'SPPHRASEELEMENT',
    'SAFT24kHz8BitStereo', 'SpeechEngineProperties',
    'SpeechPropertyResourceUsage', 'DISPID_SpeechRecoContextEvents',
    'STCLocalServer', 'SREPropertyNumChange',
    'SAFTExtendedAudioFormat', 'SVP_2', 'SPWORDPRONUNCIATION',
    'eLEXTYPE_PRIVATE15', 'SVSFIsNotXML', 'SGLexical',
    'DISPID_SRRDiscardResultInfo', 'SREStreamStart',
    'DISPID_SRGDictationSetState', 'DISPID_SABufferNotifySize',
    'DISPID_SRCEPropertyStringChange', 'SVEEndInputStream',
    'DISPID_SFSClose', 'SPPS_Modifier', 'SPAO_NONE',
    'eLEXTYPE_VENDORLEXICON', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPBO_NONE', 'DISPID_SWFEExtraData', 'ISpeechPhraseInfoBuilder',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SRIsUISupported',
    'SPCS_ENABLED', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SDKLCurrentUser', 'ISpStreamFormatConverter',
    'DISPID_SPCIdToPhone', 'DISPID_SVEEnginePrivate',
    'DISPID_SRGCommit', 'ISpeechFileStream',
    'DISPID_SRCEFalseRecognition', 'DISPID_SGRName',
    'SAFT22kHz8BitMono', 'SPSHORTCUTPAIRLIST', 'SASPause',
    'SGSDisabled', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SVEBookmark', 'SPWF_INPUT', 'Speech_Max_Word_Length',
    'SVP_5', 'SAFTCCITT_ALaw_22kHzStereo', 'SVP_21',
    ...
    'SGSExclusive', 'SPSERIALIZEDPHRASE', 'SDTPronunciation',
    'ISpeechPhraseRules', 'ISpShortcut', 'SPEI_RESERVED2',
    'ISpeechGrammarRule', 'ISpeechAudioStatus',
    'DISPID_SRCEAudioLevel', 'DISPID_SVSkip', 'SECFDefault',
    'DISPID_SRRPhraseInfo', 'SPPS_RESERVED1', 'SAFT22kHz8BitStereo',
    'SRTEmulated', 'DISPID_SpeechAudio',
    'DISPID_SPEDisplayAttributes', 'SpeechTokenIdUserLexicon',
    'SVSFDefault', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRCESoundEnd', 'SpeechGrammarWordType',
    'DISPID_SRCEHypothesis', 'DISPID_SGRId',
    'DISPID_SRGSetTextSelection', 'ISpNotifySink',
    'eLEXTYPE_PRIVATE20', 'SDTReplacement', 'ISpeechRecoResult2',
    'SpeechRegistryUserRoot', 'SpeechVoiceSkipTypeSentence',
    'SP_VISEME_14', 'Speech_StreamPos_RealTime',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SPIElements',
    'DISPID_SpeechXMLRecoResult', 'SDKLLocalMachine',
    'DISPID_SOTRemoveStorageFileName', 'SPEI_MIN_TTS',
    'DISPID_SVVolume', 'DISPID_SRRAudioFormat',
    'ISpeechPhraseProperty', 'SAFT16kHz16BitStereo', 'ISpPhrase',
    'DISPID_SRCPause', 'SWTDeleted', 'DISPID_SPPParent', 'SVP_18',
    'ISpDataKey', 'DISPID_SPIStartTime'
]

_check_version('1.1.14', 1654644454.912484)
