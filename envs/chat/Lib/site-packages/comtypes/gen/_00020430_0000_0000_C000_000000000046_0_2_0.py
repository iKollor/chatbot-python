...
__all__ = [
    'OLE_XSIZE_HIMETRIC', 'FONTITALIC', 'Monochrome', 'Default',
    'OLE_YPOS_PIXELS', 'OLE_XPOS_CONTAINER', 'OLE_YSIZE_PIXELS',
    'OLE_COLOR', 'Picture', 'FONTSTRIKETHROUGH', 'StdPicture',
    'IFont', 'OLE_OPTEXCLUSIVE', 'OLE_YPOS_CONTAINER', 'Color',
    'FONTBOLD', 'Gray', 'OLE_TRISTATE', 'OLE_YPOS_HIMETRIC',
    'OLE_YSIZE_CONTAINER', 'OLE_XSIZE_PIXELS', 'FONTNAME',
    'OLE_XSIZE_CONTAINER', 'StdFont', 'OLE_CANCELBOOL',
    'FONTUNDERSCORE', 'OLE_YSIZE_HIMETRIC', 'Checked', 'VgaColor',
    'IPicture', 'OLE_HANDLE', 'LoadPictureConstants',
    'OLE_ENABLEDEFAULTBOOL', 'OLE_XPOS_HIMETRIC', 'Unchecked',
    'OLE_XPOS_PIXELS', 'Font', 'FONTSIZE', 'IFontEventsDisp',
    'IPictureDisp', 'IFontDisp', 'FontEvents'
]

_check_version('1.1.14', 1622894681.838899)
